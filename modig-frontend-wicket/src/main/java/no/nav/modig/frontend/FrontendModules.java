...
public class FrontendModules {
    ...
    public static final FrontendModule EKSTERNFLATE_LESS = new FrontendModule.With().less(NavExtraResources.EKSTERNFLATE_LESS_RESOURCE).done();
    public static final FrontendModule STEGINDIKATOR_LESS = new FrontendModule.With().less(NavExtraResources.STEGINDIKATOR_LESS_RESOURCE).done();
    public static final FrontendModule AJAX_LOADER_LESS = new FrontendModule.With().less(NavExtraResources.AJAX_LOADER_RESOURCE).done();
    ...
    public static final FrontendModule DROPDOWN_LESS = new FrontendModule.With().less(NavExtraResources.DROPDOWN_LESS_RESOURCE).done();
    ...
    public static final FrontendModule WICKET_MODAL_WINDOW_LESS = new FrontendModule.With().less(NavExtraResources.WICKET_MODAL_WINDOW_RESOURCE).done();
    ...
    public static final FrontendModule TABLES_LESS = new FrontendModule.With().less(NavExtraResources.TABLES_LESS_RESOURCE).done();
    ...
    public static final FrontendModule DROPDOWN_JS = new FrontendModule.With().scripts(NavExtraResources.DROPDOWN_RESOURCE).done();
    public static final FrontendModule FELLES_JS = new FrontendModule.With().scripts(NavExtraResources.FELLES_JS_RESOURCE).done();
    public static final FrontendModule TOOLTIP_JS = new FrontendModule.With().scripts(NavExtraResources.TOOLTIP_RESOURCE).done();
    public static final FrontendModule JQUERY_UI_DATEPICKER_JS = new FrontendModule.With().scripts(NavExtraResources.JQUERY_UI_DATEPICKER_RESOURCE).done();
}
