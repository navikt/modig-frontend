...
(function ($, window, document) {
    ...
    AccessibleMegaMenu.prototype = (function () {
             ...
             mobileMenuMq.addListener(function() {
              ...
              if (mobileMenuMq.matches) { // mobil
               ...
               _mobileMenuDisable.call(this,varselmeny, varseltoggler);
                 ...
                 mobilesubmenus.each(function (i, submenu) {   // todo: n�dvendig med each her?
                  /*Make headings clickable */            
                        submenu = $(submenu);
                        var expander = submenu.prevAll('.mobile-submenu-expander').eq(0); // todo defaults                         
        ...
        _toggleMobileMenuAndSearch = function (event,hide) {
          ...
          if (hide) { // True ved klikk p� knapp som er .m-open, eller ved kj�ring av clickOutsideHandler
         ...
         */
         _clickHandler = function (event) {
            var target = $(event.target),
                ...
                if (target.is('a > span')) { // Spr�kvalg i mobilmeny
         ...
         */
         _clickOutsideHandler = function (event) {  
          ...
          if ((window.navigator.msPointerEnabled || window.navigator.pointerEnabled) && target.context.localName === 'html') {
            // hindre windows phone i � lukke mobilmeny p� scroll / touchmove / mspointermove
