...
public class MergedCssBuilderTest extends MergedResourceBuilderTest
{
    ...
    {
        WicketTester tester = doRender(MergedCssBuilderTestPage.class);
        assertDownloaded(tester, "static/styles.css", "css/1.css", "css/2.css");
        assertDownloaded(tester, "static/styles-print.css", "css/1-print.css", "css/2-print.css");
    }
